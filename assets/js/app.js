...
var AIURLImporter = {
  ...
  showError: function showError(error, containerSelector) {
    var message = error.message || error || 'An error occurred';
            ...
            case 5:
              ...
              if (response.status === 'completed' || response.status === 'failed') {
                ...
                if (response.status === 'completed') {
                  jQuery('.import-status-text').text("Import completed! ".concat(response.success_count, " URLs imported successfully."));
                } else if (response.status === 'failed') {
                  jQuery('.import-status-text').text("Import failed: ".concat(response.error));
                }
              }
              _context9.next = 21;
              break;
...
var FunctionsModule = {
  ...
  openAIPromptModal: function openAIPromptModal() {
    var _window$aieData16;
    // Check if API key is configured
    if (!((_window$aieData16 = window.aieData) !== null && _window$aieData16 !== void 0 && _window$aieData16.hasOpenAIApiKey)) {
      var _window$aieData17;
      var optionsUrl = ((_window$aieData17 = window.aieData) === null || _window$aieData17 === void 0 ? void 0 : _window$aieData17.optionsUrl) || 'admin.php?page=wp-aie-plugin-options';
  ...
  generateFunctionWithAI: function generateFunctionWithAI() {
    var _this10 = this;
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee8() {
      var modal, prompt, _window$aieData18, _window$aieData18$i, generatingDiv, generateBtn, _window$aieData19, _window$aieData24, _window$aieData24$i, response, _window$aieData20, _window$aieData20$i, contentType, _window$aieData21, _window$aieData21$i, data, _data$data6, _window$aieData22, _window$aieData22$i, errorMessage, _window$aieData23, _window$aieData23$i, codeTextarea, codeWithPhp, nameInput, descInput, _errorMessage, _window$aieData25, _window$aieData25$i, _window$aieData26, _window$aieData26$i, _window$aieData27, _window$aieData27$i;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              (0,_utils_notifications__WEBPACK_IMPORTED_MODULE_1__.showModalError)(((_window$aieData18 = window.aieData) === null || _window$aieData18 === void 0 ? void 0 : (_window$aieData18$i = _window$aieData18.i18n) === null || _window$aieData18$i === void 0 ? void 0 : _window$aieData18$i.prompt_required) || 'Please describe what you want the function to do.', modal);
            ...
            case 6:
              ...
              return fetch(window.aieData.ajaxUrl, {
                ...
                body: new URLSearchParams({
                  ...
                  nonce: ((_window$aieData19 = window.aieData) === null || _window$aieData19 === void 0 ? void 0 : _window$aieData19.nonce) || '',
                  prompt: prompt
                })
              });
            case 14:
              ...
              throw new Error(((_window$aieData20 = window.aieData) === null || _window$aieData20 === void 0 ? void 0 : (_window$aieData20$i = _window$aieData20.i18n) === null || _window$aieData20$i === void 0 ? void 0 : _window$aieData20$i.ai_server_error) || "Server error: ".concat(response.status, " ").concat(response.statusText));
            case 17:
              // Check if response is JSON
              contentType = response.headers.get('content-type');
              if (!(!contentType || !contentType.includes('application/json'))) {
              ...
              throw new Error(((_window$aieData21 = window.aieData) === null || _window$aieData21 === void 0 ? void 0 : (_window$aieData21$i = _window$aieData21.i18n) === null || _window$aieData21$i === void 0 ? void 0 : _window$aieData21$i.ai_invalid_response) || 'Invalid server response. Please try again or contact support.');
            case 20:
              _context8.next = 22;
              return response.json();
            case 22:
              ...
              errorMessage = data.message || ((_data$data6 = data.data) === null || _data$data6 === void 0 ? void 0 : _data$data6.message) || data.data || ((_window$aieData22 = window.aieData) === null || _window$aieData22 === void 0 ? void 0 : (_window$aieData22$i = _window$aieData22.i18n) === null || _window$aieData22$i === void 0 ? void 0 : _window$aieData22$i.ai_generation_failed) || 'Failed to generate function with AI. Please try again.';
            ...
            case 26:
              ...
              throw new Error(((_window$aieData23 = window.aieData) === null || _window$aieData23 === void 0 ? void 0 : (_window$aieData23$i = _window$aieData23.i18n) === null || _window$aieData23$i === void 0 ? void 0 : _window$aieData23$i.ai_no_code) || 'AI did not return any code. Please try a different prompt.');
            case 28:
              ...
              // Show success message
              (0,_utils_notifications__WEBPACK_IMPORTED_MODULE_1__.showNotice)(((_window$aieData24 = window.aieData) === null || _window$aieData24 === void 0 ? void 0 : (_window$aieData24$i = _window$aieData24.i18n) === null || _window$aieData24$i === void 0 ? void 0 : _window$aieData24$i.ai_generated) || 'AI has generated your function code! Please review and test it before saving.');
              _context8.next = 44;
              break;
            case 36:
              _context8.prev = 36;
              ...
              if (_context8.t0.name === 'TypeError' && _context8.t0.message.includes('fetch')) {
                _errorMessage = ((_window$aieData25 = window.aieData) === null || _window$aieData25 === void 0 ? void 0 : (_window$aieData25$i = _window$aieData25.i18n) === null || _window$aieData25$i === void 0 ? void 0 : _window$aieData25$i.ai_network_error) || 'Network error. Please check your internet connection and try again.';
              }

              // Handle timeout errors
              if (_context8.t0.name === 'AbortError' || _context8.t0.message.includes('timeout')) {
                _errorMessage = ((_window$aieData26 = window.aieData) === null || _window$aieData26 === void 0 ? void 0 : (_window$aieData26$i = _window$aieData26.i18n) === null || _window$aieData26$i === void 0 ? void 0 : _window$aieData26$i.ai_timeout_error) || 'Request timed out. The AI service may be busy. Please try again.';
              }

              // Handle JSON parse errors
              if (_context8.t0.name === 'SyntaxError' && _context8.t0.message.includes('JSON')) {
                _errorMessage = ((_window$aieData27 = window.aieData) === null || _window$aieData27 === void 0 ? void 0 : (_window$aieData27$i = _window$aieData27.i18n) === null || _window$aieData27$i === void 0 ? void 0 : _window$aieData27$i.ai_invalid_response) || 'Received invalid response from server. Please try again.';
              }
