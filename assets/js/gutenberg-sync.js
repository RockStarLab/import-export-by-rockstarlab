  ...
  var GutenbergSync = {
    ...
    addGutenbergSyncButton: function addGutenbergSyncButton() {
      ...
      if ($sidebar.length && !$('#aie-sync-content-btn').length) {
        ...
        // Create sync button
        var $button = $('<button>').attr('type', 'button').attr('id', 'aie-sync-content-btn').addClass('button button-secondary').css('width', '100%').html(((_window$aieData2 = window.aieData) === null || _window$aieData2 === void 0 ? void 0 : (_window$aieData2$i18n = _window$aieData2.i18n) === null || _window$aieData2$i18n === void 0 ? void 0 : _window$aieData2$i18n.syncThisPost) || 'Sync This Post');
