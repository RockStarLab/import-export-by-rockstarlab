...
<div class="aie-step aie-step-3" data-step="3">
	<div class="aie-step-header">
		<h2><?php esc_html_e( 'Step 3: Preview Data', 'advanced-import-export' ); ?></h2>
		<p class="description"><?php esc_html_e( 'Review the first few rows from your file', 'advanced-import-export' ); ?></p>
	</div>
	...
	<div class="aie-step-content">
		<div class="aie-preview-container">
			<div class="aie-preview-stats">
				<div class="aie-stat">
					<span class="aie-stat-label"><?php esc_html_e( 'Total Rows:', 'advanced-import-export' ); ?></span>
					<span class="aie-stat-value aie-total-rows">-</span>
				</div>
				<div class="aie-stat">
					<span class="aie-stat-label"><?php esc_html_e( 'Columns:', 'advanced-import-export' ); ?></span>
			...
			<p class="description aie-preview-note">
				<?php esc_html_e( 'Showing first 5 rows.', 'advanced-import-export' ); ?>
			</p>
		</div>
