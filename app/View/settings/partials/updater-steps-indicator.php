...
<div class="aie-steps-indicator">
	...
	<div class="aie-step-indicator" data-step="3">
		...
		<div class="aie-step-label"><?php esc_html_e( 'Select Fields', 'advanced-import-export' ); ?></div>
	</div>
	<div class="aie-step-indicator" data-step="4">
		<div class="aie-step-number">4</div>
		<div class="aie-step-label"><?php esc_html_e( 'Assign Functions', 'advanced-import-export' ); ?></div>
	</div>
	<div class="aie-step-indicator" data-step="5">
		<div class="aie-step-number">5</div>
		<div class="aie-step-label"><?php esc_html_e( 'Start Update', 'advanced-import-export' ); ?></div>
	</div>
</div>
