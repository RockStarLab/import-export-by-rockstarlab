...
<div class="aie-step aie-updater-step-4" data-step="4">
	<div class="aie-step-header">
		<h2><?php esc_html_e( 'Step 4: Assign Functions to Fields', 'advanced-import-export' ); ?></h2>
		<p class="description"><?php esc_html_e( 'Assign transformation functions to each field', 'advanced-import-export' ); ?></p>
	</div>
		...
		<div class="aie-functions-assignment">
			<div class="aie-functions-header">
				<div class="aie-functions-header-content">
					...
					<h3><?php esc_html_e( 'Field Functions', 'advanced-import-export' ); ?></h3>
				</div>
			...
			<div class="aie-functions-table-wrapper">
				<table class="wp-list-table widefat fixed striped aie-functions-table">
					<thead>
						<tr>
							<th class="aie-field-name-col"><?php esc_html_e( 'Field', 'advanced-import-export' ); ?></th>
							<th class="aie-field-type-col"><?php esc_html_e( 'Type', 'advanced-import-export' ); ?></th>
							<th class="aie-functions-col"><?php esc_html_e( 'Functions', 'advanced-import-export' ); ?></th>
							<th class="aie-actions-col"><?php esc_html_e( 'Actions', 'advanced-import-export' ); ?></th>
						</tr>
					</thead>
					<tbody id="aie-updater-functions-tbody">
						...
						<tr class="aie-no-fields-row">
							<td colspan="4" class="aie-no-fields-message">
								...
								<?php esc_html_e( 'No fields selected. Please go back and select fields first.', 'advanced-import-export' ); ?>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="aie-functions-stats">
				<div class="aie-stat-card">
					...
					<div class="aie-stat-content">
						<span class="aie-stat-label"><?php esc_html_e( 'Total Fields', 'advanced-import-export' ); ?></span>
				...
				<div class="aie-stat-card">
					...
					<div class="aie-stat-content">
						<span class="aie-stat-label"><?php esc_html_e( 'Functions Assigned', 'advanced-import-export' ); ?></span>
				...
				<div class="aie-stat-card">
					...
					<div class="aie-stat-content">
						<span class="aie-stat-label"><?php esc_html_e( 'No Function', 'advanced-import-export' ); ?></span>
