...
<div class="aie-step aie-step-6" data-step="6">
	<div class="aie-step-header">
		<h2><?php esc_html_e( 'Import in Progress', 'advanced-import-export' ); ?></h2>
		<p class="description"><?php esc_html_e( 'Please wait while your data is being imported', 'advanced-import-export' ); ?></p>
	</div>
	...
	<div class="aie-step-content">
		...
		<div class="aie-import-results" style="display:none;">
			<div class="aie-import-complete-card" style="display:none;">
				...
				<h3 class="aie-complete-title"><?php esc_html_e( 'Import Completed Successfully!', 'advanced-import-export' ); ?></h3>
				<p class="aie-complete-subtitle"><?php esc_html_e( 'Your data has been imported successfully', 'advanced-import-export' ); ?></p>
				...
				<div class="aie-results-grid">
					<div class="aie-result-item">
						...
						<div class="aie-result-details">
							<span class="aie-result-label"><?php esc_html_e( 'Successful', 'advanced-import-export' ); ?></span>
					...
					<div class="aie-result-item">
						...
						<div class="aie-result-details">
							<span class="aie-result-label"><?php esc_html_e( 'Updated', 'advanced-import-export' ); ?></span>
					...
					<div class="aie-result-item">
						...
						<div class="aie-result-details">
							<span class="aie-result-label"><?php esc_html_e( 'Created', 'advanced-import-export' ); ?></span>
					...
					<div class="aie-result-item">
						...
						<div class="aie-result-details">
							<span class="aie-result-label"><?php esc_html_e( 'Failed', 'advanced-import-export' ); ?></span>
		...
		<div class="aie-step-actions">
			...
			<button type="button" class="button button-primary aie-new-import" style="display:none;">
				...
				<?php esc_html_e( 'New Import', 'advanced-import-export' ); ?>
			</button>
		</div>
	</div>
</div>
