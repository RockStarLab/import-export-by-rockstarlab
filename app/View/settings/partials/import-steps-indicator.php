...
<div class="aie-steps-indicator">
	...
	<div class="aie-step-indicator" data-step="2">
		...
		<div class="aie-step-label"><?php esc_html_e( 'Upload', 'amplified-import-export' ); ?></div>
	</div>
	<div class="aie-step-indicator" data-step="3">
		<div class="aie-step-number">3</div>
		<div class="aie-step-label"><?php esc_html_e( 'Preview', 'amplified-import-export' ); ?></div>
	</div>
	<div class="aie-step-indicator" data-step="4">
		<div class="aie-step-number">4</div>
		<div class="aie-step-label"><?php esc_html_e( 'Mapping', 'amplified-import-export' ); ?></div>
	</div>
	<div class="aie-step-indicator" data-step="5">
		<div class="aie-step-number">5</div>
		<div class="aie-step-label"><?php esc_html_e( 'Options', 'amplified-import-export' ); ?></div>
	</div>
	<div class="aie-step-indicator" data-step="6">
		<div class="aie-step-number">6</div>
		<div class="aie-step-label"><?php esc_html_e( 'Import', 'amplified-import-export' ); ?></div>
	</div>
</div>
