		...
		<div class="rsl-ie-content-types">
			...
			<label class="rsl-ie-content-type">
				...
				<div class="rsl-ie-content-type-card">
					...
					<p><?php esc_html_e( 'Export synced block patterns', 'import-export-by-rockstarlab' ); ?></p>
				</div>
			</label>
			...
			<label class="rsl-ie-content-type">
				...
				<div class="rsl-ie-content-type-card">
					...
					<p><?php esc_html_e( 'Export block theme navigation menus', 'import-export-by-rockstarlab' ); ?></p>
				</div>
			</label>
					...
					<div class="rsl-ie-content-type-card">
						...
						<?php if ( ! $rsl_ie_pro_active ) : ?>
							<div class="rsl-ie-pro-addon-dismiss">
								<button type="button" class="button-link rsl-ie-pro-addon-hide" data-context="export">
									<?php esc_html_e( 'Hide', 'import-export-by-rockstarlab' ); ?>
								</button>
								<span class="rsl-ie-pro-addon-dismiss-sep">·</span>
								<button type="button" class="button-link rsl-ie-pro-addon-dismiss-forever" data-context="export">
