...
<div class="aie-step aie-step-1 active" data-step="1">
	<div class="aie-step-header">
		...
		<p class="description"><?php esc_html_e( 'Choose what type of data you want to export', 'wp-advanced-import-export' ); ?></p>
	</div>
		...
		<div class="aie-content-types">
			...
			<label class="aie-content-type">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export blog posts', 'wp-advanced-import-export' ); ?></p>
				</div>
			</label>
			...
			<label class="aie-content-type">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export pages', 'wp-advanced-import-export' ); ?></p>
				</div>
			</label>
