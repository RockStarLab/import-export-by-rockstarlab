...
<div class="aie-step aie-step-1 active" data-step="1">
	...
	<div class="aie-step-content">
		...
		$promo_dismissed = (bool) get_user_meta( get_current_user_id(), 'rsl_ie_dismiss_pro_promo_export', true );

		$promo_title = __( 'Need more features? Buy PRO addon', 'import-export-by-rockstarlab' );
		$promo_desc  = __( 'Get additional export content types by installing the PRO addon.', 'import-export-by-rockstarlab' );

		$promo_features = \RockStarLab\ImportExport\Helper\Pro_Addon::get_promo_features( 'export' );
		...
		<div class="aie-content-types">
			...
			<?php if ( $pro_active ) : ?>
				<?php
				$pro_types  = \RockStarLab\ImportExport\Helper\Pro_Addon::get_pro_content_type_cards( 'export' );
				$pro_types  = apply_filters( 'rsl_ie_pro_export_content_types', $pro_types );
				$pro_locked = false;
