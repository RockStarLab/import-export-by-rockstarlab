...
<div class="aie-step aie-step-1 active" data-step="1">
	<div class="aie-step-header">
		...
		<p class="description"><?php esc_html_e( 'Choose what type of data you want to export', 'amplified-import-export' ); ?></p>
	</div>
		...
		<div class="aie-content-types">
			...
			<label class="aie-content-type">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export blog posts', 'amplified-import-export' ); ?></p>
				</div>
			</label>
			...
			<label class="aie-content-type">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export pages', 'amplified-import-export' ); ?></p>
				</div>
			</label>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export custom post types', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export media files data', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export navigation menus', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export user accounts', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export comments and reviews', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export categories, tags, and custom taxonomies', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export WooCommerce products', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export WooCommerce orders', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export WooCommerce coupons', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export WooCommerce attributes', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Export any MySQL table fields', 'amplified-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'amplified-import-export' ); ?></span>
					<?php endif; ?>
				</div>
