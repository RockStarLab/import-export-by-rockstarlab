...
<div class="aie-step aie-updater-step-2" data-step="2">
	<div class="aie-step-header">
		<h2><?php esc_html_e( 'Step 2: Filter Data (Optional)', 'amplified-import-export' ); ?></h2>
		<p class="description"><?php esc_html_e( 'Apply filters to select specific items to update. Leave empty to update all items.', 'amplified-import-export' ); ?></p>
	</div>
	...
	<div class="aie-step-content">
		...
		<div class="aie-table-selection-section" style="display:none;">
			<div class="aie-section-header">
				...
				<p class="description"><?php esc_html_e( 'Choose which database table you want to update', 'amplified-import-export' ); ?></p>
			</div>

			<div class="aie-table-selector">
				<label for="aie-updater-table-name"><?php esc_html_e( 'Database Table:', 'amplified-import-export' ); ?></label>
		...
		<div class="aie-updater-filters-notice">
			<div class="notice notice-info inline">
				<p>
					...
					<?php esc_html_e( 'Filters are optional. If you don\'t add any filters, all items of the selected content type will be updated.', 'amplified-import-export' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="aie-filter-summary-top">
			<div class="aie-summary-card">
				...
				<div class="aie-summary-content">
					<div class="aie-summary-label"><?php esc_html_e( 'Total Items to Update', 'amplified-import-export' ); ?></div>
		...
		<div class="aie-custom-filters-section">
			<div class="aie-section-header">
				...
				<p class="description"><?php esc_html_e( 'Add custom filters to narrow down which items to update', 'amplified-import-export' ); ?></p>
			</div>
			...
			<div class="aie-filter-row">
				<div class="aie-filter-row-inner">
					...
					<div class="aie-filter-value-wrap">
						...
						<input type="text" class="aie-updater-filter-value" name="updater_filter_value[]" placeholder="<?php esc_attr_e( 'Enter value...', 'amplified-import-export' ); ?>">
					</div>

					<!-- Remove Button -->
					<div class="aie-filter-actions">
						<button type="button" class="button button-link-delete aie-updater-remove-filter" title="<?php esc_attr_e( 'Remove filter', 'amplified-import-export' ); ?>">
