...
<div class="aie-step aie-step-1 active" data-step="1">
	<div class="aie-step-header">
		...
		<p class="description"><?php esc_html_e( 'Choose what type of data you want to import', 'advanced-import-export' ); ?></p>
	</div>
		...
		<div class="aie-content-types">
			...
			<label class="aie-content-type">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import blog posts', 'advanced-import-export' ); ?></p>
				</div>
			</label>
			...
			<label class="aie-content-type">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import pages', 'advanced-import-export' ); ?></p>
				</div>
			</label>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import custom post types', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import media files data', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import navigation menus', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import user accounts', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import comments and reviews', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import categories, tags, and custom taxonomies', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import WooCommerce products', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import WooCommerce orders', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import WooCommerce coupons', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import WooCommerce attributes', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
			...
			<label class="aie-content-type<?php echo $is_premium ? '' : ' aie-premium-locked'; ?>">
				...
				<div class="aie-content-type-card">
					...
					<p><?php esc_html_e( 'Import to any MySQL table', 'advanced-import-export' ); ?></p>
					<?php if ( ! $is_premium ) : ?>
						<span class="aie-premium-badge"><?php esc_html_e( 'Premium', 'advanced-import-export' ); ?></span>
					<?php endif; ?>
				</div>
