...
<div class="aie-functions-table-container">
	<table class="wp-list-table widefat fixed striped aie-functions-table">
		<thead>
			<tr>
				<th class="column-name"><?php esc_html_e( 'Name', 'wp-advanced-import-export' ); ?></th>
				<th class="column-description"><?php esc_html_e( 'Description', 'wp-advanced-import-export' ); ?></th>
		...
		<tbody id="aie-functions-tbody">
			<tr class="aie-loading-row">
				<td colspan="3" style="text-align:center;">
					...
					<?php esc_html_e( 'Loading functions...', 'wp-advanced-import-export' ); ?>
				</td>
			</tr>
		</tbody>
	</table>
...
<div class="aie-functions-pagination">
	...
	<div class="aie-pagination-controls">
		...
		<span class="aie-page-info">
			<?php esc_html_e( 'Page', 'wp-advanced-import-export' ); ?> <span class="aie-current-page">1</span> / <span class="aie-total-pages">1</span>
		</span>
