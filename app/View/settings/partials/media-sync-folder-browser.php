	...
	<div class="aie-modal-content">
		<div class="aie-modal-header">
			<h2>
				...
				<?php esc_html_e( 'Browse Server Folders', 'advanced-import-export' ); ?>
			</h2>
		...
		<div class="aie-modal-body">
			<p class="description" style="margin-bottom: 15px; padding: 8px 12px; background: #f0f0f1; border-left: 3px solid #2271b1;">
				...
				<?php esc_html_e( 'Click to select a folder, double-click to open it.', 'advanced-import-export' ); ?>
			</p>
			...
			<div id="aie-folder-browser-loading" class="aie-loading" style="display: none;">
				...
				<?php esc_html_e( 'Loading folders...', 'advanced-import-export' ); ?>
			</div>
			...
			<div id="aie-folder-browser-empty" style="display: none;">
				<p class="description">
					<?php esc_html_e( 'No subfolders found in this directory.', 'advanced-import-export' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="aie-modal-footer">
			<input 
				...
				class="regular-text" 
				readonly
				placeholder="<?php esc_attr_e( 'No folder selected', 'advanced-import-export' ); ?>"
			>
			<button type="button" id="aie-choose-folder-btn" class="button button-primary" disabled>
				<span class="dashicons dashicons-yes"></span>
				<?php esc_html_e( 'Choose', 'advanced-import-export' ); ?>
			</button>
