...
<div class="rsl-ie-step rsl-ie-updater-step-1 active" data-step="1">
	...
	<div class="rsl-ie-step-content">
		...
		?>
			...
			<?php if ( $rsl_ie_pro_active ) : ?>
				<?php do_action( 'rsl_ie_pro_license_notice', 'updater' ); ?>
			<?php endif; ?>
			...
			<div class="rsl-ie-content-type-filter">
				<input 
				type="text" 
				id="rsl-ie-updater-content-type-search" 
				class="regular-text" 
					...
					<div class="rsl-ie-content-type-card">
						...
						<?php if ( ! $rsl_ie_pro_active ) : ?>
							<div class="rsl-ie-pro-addon-dismiss">
								<button type="button" class="button-link rsl-ie-pro-addon-hide" data-context="updater">
									<?php esc_html_e( 'Hide', 'import-export-by-rockstarlab' ); ?>
								</button>
								<span class="rsl-ie-pro-addon-dismiss-sep">·</span>
								<button type="button" class="button-link rsl-ie-pro-addon-dismiss-forever" data-context="updater">
