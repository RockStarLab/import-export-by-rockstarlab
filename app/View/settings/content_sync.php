...
<div id="wp-aie-content-sync" class="amplified-import-export wrap">
	<h1><?php esc_html_e( 'Content Sync', 'amplified-import-export' ); ?></h1>
	<p class="description">
		<?php esc_html_e( 'Manage connections between WordPress sites for content synchronization. Connect multiple sites and sync posts, pages, and other content types.', 'amplified-import-export' ); ?>
	</p>
	...
	<div class="aie-premium-notice">
		...
		<div class="aie-premium-notice-content">
			<h3><?php esc_html_e( 'Premium Feature', 'amplified-import-export' ); ?></h3>			<p><?php esc_html_e( 'In the Premium version, you can synchronize ALL Pages and Custom Post Types between WordPress sites. Free version supports Posts synchronization only.', 'amplified-import-export' ); ?></p>
	...
	<div class="aie-content-sync-stats">
		<div class="aie-stat-card">
			...
			<div class="aie-stat-info">
				...
				<div class="aie-stat-label"><?php esc_html_e( 'Total Sites', 'amplified-import-export' ); ?></div>
			</div>
		</div>
		...
		<div class="aie-stat-card">
			...
			<div class="aie-stat-info">
				...
				<div class="aie-stat-label"><?php esc_html_e( 'Active', 'amplified-import-export' ); ?></div>
			</div>
		</div>
		...
		<div class="aie-stat-card">
			...
			<div class="aie-stat-info">
				...
				<div class="aie-stat-label"><?php esc_html_e( 'Error', 'amplified-import-export' ); ?></div>
			</div>
		</div>
	</div>
	...
	<div class="aie-content-sync-section aie-my-site-section">
		<div class="aie-section-header">
			<h2><?php esc_html_e( 'This Site Configuration', 'amplified-import-export' ); ?></h2>
			<button type="button" class="button button-secondary" id="aie-toggle-my-site">
				<span class="dashicons dashicons-visibility"></span>
				<?php esc_html_e( 'Show Details', 'amplified-import-export' ); ?>
			</button>
		</div>
		<div class="aie-my-site-info" style="display: none;">
			<p class="description">
				<?php esc_html_e( 'Use these details to connect this site from another WordPress installation:', 'amplified-import-export' ); ?>
			</p>
			<div class="aie-info-grid">
				<div class="aie-info-item">
					<label><?php esc_html_e( 'Site Name:', 'amplified-import-export' ); ?></label>
					<input type="text" class="regular-text" id="aie-my-site-name" readonly />
				</div>
				<div class="aie-info-item">
					<label><?php esc_html_e( 'Site URL:', 'amplified-import-export' ); ?></label>
					<input type="text" class="regular-text" id="aie-my-site-url" readonly />
				</div>
				<div class="aie-info-item aie-info-item-full">
					<label><?php esc_html_e( 'API Key:', 'amplified-import-export' ); ?></label>
					<div class="aie-api-key-field">
						...
						<button type="button" class="button button-secondary" id="aie-regenerate-my-key">
							...
							<?php esc_html_e( 'Regenerate', 'amplified-import-export' ); ?>
						</button>
					</div>
					<p class="description">
						<?php esc_html_e( 'Keep this API key secure. It allows other sites to connect to this site.', 'amplified-import-export' ); ?>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="aie-content-sync-section">
		<div class="aie-section-header">
			<h2><?php esc_html_e( 'Connected Sites', 'amplified-import-export' ); ?></h2>
			<button type="button" class="button button-primary" id="aie-add-site-btn">
				<span class="dashicons dashicons-plus-alt"></span>
				<?php esc_html_e( 'Add New Site', 'amplified-import-export' ); ?>
			</button>
		</div>
		...
		<div class="aie-sites-table-wrapper">
			<table class="wp-list-table widefat fixed striped aie-sites-table">
				<thead>
					<tr>
						<th class="column-name"><?php esc_html_e( 'Site Name', 'amplified-import-export' ); ?></th>
						<th class="column-url"><?php esc_html_e( 'URL', 'amplified-import-export' ); ?></th>
						<th class="column-status"><?php esc_html_e( 'Status', 'amplified-import-export' ); ?></th>
						<th class="column-last-sync"><?php esc_html_e( 'Last Sync', 'amplified-import-export' ); ?></th>
				...
				<tbody id="aie-sites-list">
					<tr class="aie-no-sites">
						<td colspan="5" style="text-align: center; padding: 40px;">
							...
							<p style="margin-top: 40px"><?php esc_html_e( 'No connected sites yet. Add your first connection!', 'amplified-import-export' ); ?></p>
						</td>
					</tr>
				</tbody>
			</table>
...
<div id="aie-site-modal" class="aie-modal" style="display: none;">
	<div class="aie-modal-content">
		<div class="aie-modal-header">
			<h2 id="aie-modal-title"><?php esc_html_e( 'Add New Site', 'amplified-import-export' ); ?></h2>
			...
			<form id="aie-site-form">
				...
				<div class="aie-form-row">
					<label for="aie-site-name">
						<?php esc_html_e( 'Site Name', 'amplified-import-export' ); ?>
						<span class="required">*</span>
					</label>
					<input type="text" id="aie-site-name" name="name" class="regular-text" required />
					<p class="description"><?php esc_html_e( 'A friendly name for this connection', 'amplified-import-export' ); ?></p>
				</div>

				<div class="aie-form-row">
					<label for="aie-site-url">
						<?php esc_html_e( 'Remote Site URL', 'amplified-import-export' ); ?>
						<span class="required">*</span>
					</label>
					<input type="url" id="aie-site-url" name="remote_url" class="regular-text" placeholder="https://example.com" required />
					<p class="description"><?php esc_html_e( 'The full URL of the WordPress site to connect', 'amplified-import-export' ); ?></p>
				</div>

				<div class="aie-form-row">
					<label for="aie-site-api-key">
						<?php esc_html_e( 'Remote API Key', 'amplified-import-export' ); ?>
						<span class="required">*</span>
					</label>
					<input type="text" id="aie-site-api-key" name="api_key" class="regular-text" />
					<p class="description"><?php esc_html_e( 'API key from the remote site', 'amplified-import-export' ); ?></p>
				</div>
			</form>
		</div>
		<div class="aie-modal-footer">
			...
			<button type="button" class="button button-primary" id="aie-save-site-btn">
				<?php esc_html_e( 'Save Connection', 'amplified-import-export' ); ?>
			</button>
		</div>
	</div>
</div>
