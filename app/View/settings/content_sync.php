...
<div id="wp-aie-content-sync" class="wp-advanced-import-export wrap">
	...
	<div class="aie-premium-notice">
		...
		<div class="aie-premium-notice-content">
			<h3><?php esc_html_e( 'Premium Feature', 'wp-advanced-import-export' ); ?></h3>			<p><?php esc_html_e( 'In the Premium version, you can synchronize ALL Pages and Custom Post Types between WordPress sites. Free version supports Posts synchronization only.', 'wp-advanced-import-export' ); ?></p>
