		...
		wp_localize_script(
			...
			array(
				...
				'i18n'           => array(
					...
					'selectTaxonomyDataFormat'   => __( 'Select the format of taxonomy data in your CSV file.', 'wp-advanced-import-export' ),
					'taxonomySlugLabel'          => __( 'Taxonomy Slug', 'wp-advanced-import-export' ),
