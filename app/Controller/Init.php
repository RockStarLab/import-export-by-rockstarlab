	...
	if ( ! in_array(
		...
		wp_localize_script(
			...
			array(
				...
				'isPremium'      => function_exists( 'rsl_ie_fs' ) && rsl_ie_fs()->can_use_premium_code(),
				'premiumDataTypes' => [
				...
				'i18n'           => array(
					...
					'selectTaxonomyDataFormat'   => __( 'Select the format of taxonomy data in your CSV file.', 'import-export-by-rockstarlab' ),				'taxonomySlugLabel'          => __( 'Taxonomy Slug', 'import-export-by-rockstarlab' ),
			...
			'after'                      => __( 'After', 'import-export-by-rockstarlab' ),				// Content Sync
				...
				'retryRequiresPremium'       => __( 'A valid premium license is required to retry this job. Please activate or renew your license.', 'import-export-by-rockstarlab' ),
			),
		)
