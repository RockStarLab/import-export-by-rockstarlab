		...
		wp_localize_script(
			...
			array(
				...
				'i18n'        => array(
					...
					'name_required'     => __( 'Please enter a function name.', 'wp-aie' ),
					'code_required'     => __( 'Please enter the PHP code for your function.', 'wp-aie' ),
					'category_required' => __( 'Please select a category.', 'wp-aie' ),
				),
			)
		);
