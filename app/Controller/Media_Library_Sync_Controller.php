...
class Media_Library_Sync_Controller {
	...
	private function create_attachment_from_media_payload( $item ) {
		...
		if ( ! empty( $item['attachment_id'] ) ) {
			$this->add_unique_attachment_source_meta( (int) $attachment_id, '_rsl_ie_original_attachment_id', absint( $item['attachment_id'] ) );
			$this->add_unique_attachment_source_meta( (int) $attachment_id, '_rsl_ie_source_attachment_id', absint( $item['attachment_id'] ) );
		}
		if ( ! empty( $item['source_origin_attachment_id'] ) ) {
			$this->add_unique_attachment_source_meta( (int) $attachment_id, '_rsl_ie_source_origin_attachment_id', absint( $item['source_origin_attachment_id'] ) );
		}
