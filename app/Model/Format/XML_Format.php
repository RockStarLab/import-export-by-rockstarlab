...
class XML_Format implements File_Format_Interface {
	...
	public function parse( $file_path, $options = [] ) {
		if ( ! file_exists( $file_path ) ) {
			return new \WP_Error( 'file_not_found', __( 'XML file not found', 'wp-advanced-import-export' ) );
		}
		...
		if ( ! $result ) {
			return new \WP_Error( 'file_open_error', __( 'Cannot open XML file', 'wp-advanced-import-export' ) );
		}
	...
	public function validate( $file_path ) {
		...
		if ( ! is_readable( $file_path ) ) {
			return new \WP_Error( 'file_not_readable', __( 'XML file is not readable', 'wp-advanced-import-export' ) );
		}

		// Check file extension
		$extension = strtolower( pathinfo( $file_path, PATHINFO_EXTENSION ) );
		if ( ! in_array( $extension, $this->get_extensions(), true ) ) {
			return new \WP_Error( 'invalid_extension', __( 'Invalid XML file extension', 'wp-advanced-import-export' ) );
		}
		...
		if ( false === $xml ) {
			...
			return new \WP_Error(
				...
				sprintf(
					...
					__( 'Invalid XML: %s', 'wp-advanced-import-export' ),
