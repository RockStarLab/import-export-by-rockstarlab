...
abstract class Abstract_Exporter implements Exporter_Interface {
	...
	public function validate_options( $options ) {
		...
		if ( isset( $options['limit'] ) && ! is_numeric( $options['limit'] ) ) {
			return new \WP_Error( 'invalid_limit', __( 'Limit must be a number', 'wp-advanced-import-export' ) );
		}

		if ( isset( $options['offset'] ) && ! is_numeric( $options['offset'] ) ) {
			return new \WP_Error( 'invalid_offset', __( 'Offset must be a number', 'wp-advanced-import-export' ) );
		}
